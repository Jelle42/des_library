...
def setup_sdp(c: list[float], outpatient_schedule: dict[dp.StageType, int], params: dict[str, float] = {"r_O": 100, "r_I": 20, "w_O": 1.5, "w_I": 0, "pi_O": 10, "pi_I":200}, max_n: int = 100) -> tuple[dp.SDP, dict[dp.StateType, float]]:
